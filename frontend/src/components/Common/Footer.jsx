    ...
    <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 lg:px-0">
      <div>
        ...
        <form className="flex">
          ...
          <button type="submit" className="bg-black text-white px-6 py-3 text-sm rounded-r-md hover:bg-gray-800 transition-all hover:cursor-pointer">Subscribe</button>
        </form>
      </div>
      {/* Shop Links */}
      <div>
